...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../output/figures/climate_maps_spatial_risk_evolution.png}
\caption{Spatial evolution of fire risk by fire brigade zone for August under RCP4.5 (top row) and RCP8.5 (bottom row) scenarios. Maps show projected fire risk for 2020, 2050, and 2080. Both scenarios show increasing risk over time, with RCP8.5 projecting substantially higher risk particularly in central and eastern zones. Color scale represents relative fire risk from low (yellow) to high (dark red).}
\label{fig:climate_maps}
\end{figure}

Figure \ref{fig:climate_timeseries} quantifies risk evolution for key zones with uncertainty estimates from climate model spread.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../output/figures/climate_timeseries_with_uncertainty.png}
\caption{Projected fire risk evolution (August) for major zones under RCP4.5 (left) and RCP8.5 (right) scenarios. Points show median climate model projection, error bars represent uncertainty range from 25th to 99th percentile climate outcomes. Each zone shown in different color with full legend. Error bars properly centered on median values. RCP8.5 projects substantially higher risk increases than RCP4.5, with median increases of 43\% vs 14\% by 2080.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../output/figures/climate_maps_risk_change.png}
\caption{Percent change in fire risk from 2020 to 2080 under RCP4.5 (left) and RCP8.5 (right) scenarios. Color scale shows percentage increase (red) or decrease (blue). Under RCP4.5, the median zone experiences 14\% increase with range from -10\% to +43\%. Under RCP8.5, median increase is 43\% with range from +13\% to +116\%. Highest increases projected for mountain zones in northern areas (San Giovanni Vizze: +116\% under RCP8.5).}
