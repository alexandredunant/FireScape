...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../output/04_Zone_Climate_Projections/historical_vs_ensemble_members_bolzano.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../output/04_Zone_Climate_Projections/rcp85_ensemble_members/timeseries_top_zones_combined.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../output/04_Zone_Climate_Projections/rcp85_ensemble_members/spatial_evolution_worst_case_summary.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../output/04_Zone_Climate_Projections/rcp85_ensemble_members/timeseries_ensemble_spread_all_seasons.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../output/04_Zone_Climate_Projections/rcp85_ensemble_members/timeseries_ensemble_min_mean_max.png}
