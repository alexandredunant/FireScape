...
\caption{Percent change in fire risk from 2020 to 2080 under RCP4.5 (left) and RCP8.5 (right) scenarios. Color scale shows percentage increase (red) or decrease (blue). Under RCP4.5, the median zone experiences 15\% increase with range from -36\% to +139\%. Under RCP8.5, median increase is 45\% with range from -26\% to +176\%. Highest increases projected for central mountain zones (Roncadizza, Merano area).}
