...
if __name__ == "__main__":
    ...
    # Handle landcoverfull as categorical (majority vote / mode)
    landcover_data_full = ds[main_data_var].sel(channel='landcover_fire_risk').isel(time=0)  # id_obs x y x x
    ...
    landcover_mode = landcover_mode.assign_coords(channel=['landcover_fire_risk'])
